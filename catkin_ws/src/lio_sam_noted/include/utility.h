...
public:
    ...
    /*局部小地图设置*/
    float surroundingkeyframeAddingDistThreshold;  //距离
    float surroundingkeyframeAddingAngleThreshold; //角度
    float surroundingKeyframeDensity;              //密度
    float surroundingKeyframeSearchRadius;         //搜索半径

    /*回环检测*/
    bool loopClosureEnableFlag;          //是否开启
    float loopClosureFrequency;          //频率
    int surroundingKeyframeSize;         //子图大小
    float historyKeyframeSearchRadius;   //历史帧搜索半径
    float historyKeyframeSearchTimeDiff; //搜索时间差
    int historyKeyframeSearchNum;        //历史帧搜索范围
    float historyKeyframeFitnessScore;   //匹配得分
